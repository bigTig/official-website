...
export class Request {
  ...
  /** Post 请求 */
  public post<P = any, R = any>(url: string, data?: P, config?: AxiosRequestConfig): Promise<AxiosResponse<Result<R>>> {
    return this.instance.post(url, data, config);
  }

  /** Put 请求 */
  public put<P = any, R = any>(url: string, data?: P, config?: AxiosRequestConfig): Promise<AxiosResponse<Result<R>>> {
    return this.instance.put(url, data, config);
  }

  /** delete 请求 */
  public delete<R = any>(url: string, config?: AxiosRequestConfig): Promise<AxiosResponse<Result<R>>> {
